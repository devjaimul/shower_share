...
class ShowerEditScreen extends StatelessWidget {
  ...
  final bool? isEdit;
   ...
   ShowerEditScreen({super.key, this.isEdit});
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: CustomTextOne(
          text:isEdit==true?'Edit': 'Registration',
          fontSize: 18.sp,
        ),
      ),
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            const CustomTextTwo(
              text: 'Upload your shower\'s Picture',
            ),
            SizedBox(height: 8.h),
            GestureDetector(
            ...
            CustomTextField(
              labelText: 'Home Name',
              controller:
                  TextEditingController(text: controller.homeName.value),
              onChanged: (value) => controller.homeName.value = value,
            ),
            SizedBox(height: 16.h),
            const CustomTextTwo(text: 'Address'),
            SizedBox(height: 8.h),
            CustomTextField(
              labelText: 'Address',
            ...
            SizedBox(height: 16.h),
            const CustomTextTwo(text: 'Details'),
            SizedBox(height: 8.h),
            CustomTextField(
              labelText: 'Details',
            ...
            SizedBox(height: 16.h),
            const CustomTextTwo(text: 'Price/hour'),
            SizedBox(height: 8.h),
            CustomTextField(
              labelText: 'Price/hour',
              controller:
                  TextEditingController(text: controller.pricePerHour.value),
            ...
            SizedBox(height: 16.h),
            const CustomTextTwo(text: 'Available service'),
            SizedBox(height: 8.h),
            Row(
              children: [
                Expanded(
                ...
                SizedBox(width: 30.w, child: const CustomTextTwo(text: 'to')),
                Expanded(
                  child: GestureDetector(
                ...
                SizedBox(
                  ...
                  child: CustomTextField(
                    ...
                    controller: TextEditingController(
                        text: controller.timeExtensionPrice.value),
                    onChanged: (value) =>
                        controller.timeExtensionPrice.value = value,
                    keyboardType: TextInputType.number,
                  ),
                ),
              ],
            ...
            CustomTextButton(
              text: isEdit==true?'Save Change':'Submit',
              onTap: () {
